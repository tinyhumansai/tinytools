...
//!
//! # Why this is not a provider message type
//!
...
//! that host's dialect logic into this crate through a specific provider's
//! message type would mean a lossy round-trip, and the loss would land
...
//!
//! A harness can provide its own adapter between these records and its richer
//! message model without coupling this protocol crate to that model.
